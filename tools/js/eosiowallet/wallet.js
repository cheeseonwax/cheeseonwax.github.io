...
var chainID = "1064487b3cd1a897ce03ae5b6a865651747e2e152090f99c1d19d44e01aea5a4"; // wax
// wax
var wax = null;
...
//var   thenode      = "wax.pink.gg"; // 
var   thenode      = "wax.greymass.com"; // 
...
/* WAX */
  ...
  async function getCurrentMessageWCW() {
    ...
    const message2 = res.rows[0] ? res.rows[0].message : `<No message is set for ${wax.userAccount}>`;
...
*/
 ...
 console.log("LOGIN WAX CLOUD WALLET...");
 
        try {
            console.log("pre login...wcw ...");
            //if autologged in, this simply returns the userAccount w/no popup
            const userAccount = await wax.login('cheeseonwax');
            
            console.log("post login...wcw ...");
    ...
    try {
      ...
      const userAccount = await wax.login('noncerandom3');
            */
           
          //  await getCurrentMessageWCW();

     if (wax.user.isProofVerified) {
        console.log(' User login proof is valid');
        ...
        console.log(' User login proof is invalid');
      }
...
if (currentwallet == "WCW")
   ...
   try {
     ...
     console.log("jsonerr wcw: " + e.message);
